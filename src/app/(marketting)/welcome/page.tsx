...
function WelcomePage() {
  ...
  return (
    <div className="flex w-full h-[80dvh] items-center justify-center px-4">
      ...
      <div className="relative z-10 flex -translate-y-1/2 flex-col items-center gap-6 text-center">
        <LoadingSpinner />
        <h1 className="text-5xl font-bold text-center">{'يتم انشاء حسابك الآن... انتظر'}</h1>
        <p className="text-base/7 text-gray-600 max-w-prose">
          {'من فضلك انتظر حتى يتم انشاء حسابك الخاص بك.'}
        </p>
      </div>
    </div>
  );
