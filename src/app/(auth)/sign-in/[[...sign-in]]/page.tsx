          ...
          {(isGlobalLoading) => (
            <>
              <SignIn.Step name="start">
                <Card className="w-full sm:w-96">
                  <CardHeader className='text-center'>
                    <CardTitle className='text-center'>{'سجل الدخول لمتابعه التسويق'}</CardTitle>
                    <CardDescription className='text-center text-pretty'>{'مرحبا! برجاء تسجيل الدخول لمتابعة حملاتك'}</CardDescription>
                  </CardHeader>
              ...
              <SignIn.Step name="choose-strategy">
                <Card className="w-full sm:w-96">
                  <CardHeader>
                    <CardTitle>{"تجربة طريقه اخري"}</CardTitle>
                    <CardDescription>
                      {'تواجه مشاكل؟ يمكنك استخدام أي من هذه الطرق لتسجيل الدخول'}
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-y-4">
                  ...
                  <Card className="w-full sm:w-96">
                    <CardHeader>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {'مرحبًا بعودتك'} <SignIn.SafeIdentifier />
                      </p>
                    </CardHeader>
                    <CardContent className="grid gap-y-4">
                ...
                <SignIn.Strategy name="email_code">
                  <Card className="w-full sm:w-96">
                    <CardHeader>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {'مرحباً بعودتك'} <SignIn.SafeIdentifier />
                      </p>
                    </CardHeader>
                    <CardContent className="grid gap-y-4">
                      <Clerk.Field name="code">
                        <Clerk.Label className="sr-only">{'رمز التحقق عبر البريد الإلكتروني'}</Clerk.Label>
